[MINOR] 1.0.0 — 2026-05-24 — Initial construction.
[MINOR] architectural-patterns.md 1.1.0 — 2026-05-24 — Populated 11 patterns with code-grounded falsifiers and production call graph. Trigger: new architectural pattern confirmed.
[MINOR] failure-taxonomy.md 1.1.0 — 2026-05-24 — Project layer framework (L0/L2/L3/L5) and 24 cause classes. Trigger: new failure class confirmed.
[MINOR] known-coupling-surfaces.md 1.1.0 — 2026-05-24 — Expanded to 19 surfaces including chunk ID algorithm, CLI→API inversion, LLMClient defaults. Trigger: schema change / user confirmation.
